...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = video_in_0_axi_vdma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_demosaic
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = video_in_0_v_demosaic_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.5
 PARAMETER HW_INSTANCE = video_in_1_axi_vdma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_demosaic
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = video_in_1_v_demosaic_0
END
