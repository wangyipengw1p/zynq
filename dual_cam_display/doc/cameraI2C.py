...
def read_byte(smb,addr):
    ...
    return bin(smb.read_byte(slaveaddr))
...
def init_cam(smb):
    init = [(0x0103, 0x01),#  ; software reset
    (0xffff,0x15),
...
def load_preview(smb):
    #ov5640.h /* @@ MIPI_2lane_5M to vga(YUV) 30fps 99 640 480 98 0 0 */
    #preview = [(0x3503, 0x00), (0x3035, 0x14), (0x30

#, 0x38), (0x3820, 0x41), (0x3821, 0x07), (0x3814, 0x31), (0x3815, 0x31), (0x3803, 0x04), (0x3807, 0x9b), (0x3808, 0x02), (0x3809, 0x80), (0x380a, 0x01), (0x380b, 0xe0), (0x380c, 0x07), (0x380d, 0x68), (0x380e, 0x03), (0x380f, 0xd8), (0x3813, 0x06), (0x3618, 0x00), (0x3612, 0x29), (0x3708, 0x64), (0x3709, 0x52), (0x370c, 0x03), (0x5001, 0xa3), (0x4004, 0x02), (0x4005, 0x18), (0x4837, 0x44), (0x4713, 0x03), (0x4407, 0x04), (0x460b, 0x35), (0x460c, 0x22), (0x3824, 0x02)]
    
    #ov5640_for_td8801.c /* 720p 15fps @ 1280x720 */
    #preview = [(0x3503, 0x00), (0x3c07, 0x07), (0x3803, 0xfa), (0x3806, 0x06), (0x3807, 0xa9), (0x3808, 0x05), (0x3809, 0x00), (0x380a, 0x02), (0x380b, 0xd0), (0x380c, 0x07), (0x380d, 0x64), (0x380e, 0x02), (0x380f, 0xe4), (0x3813, 0x04), (0x3a02, 0x02), (0x3a03, 0xe4), (0x3a08, 0x01), (0x3a09, 0xbc), (0x3a0a, 0x01), (0x3a0b, 0x72), (0x3a0e, 0x01), (0x3a0d, 0x02), (0x3a14, 0x02), (0x3a15, 0xe4), (0x3820, 0x41), (0x3821, 0x07), (0x3814, 0x31), (0x3815, 0x31), (0x3618, 0x00), (0x3612, 0x29), (0x3709, 0x52), (0x370c, 0x03), (0x3a02, 0x03), (0x3a03, 0xd8), (0x3a08 , 0x01), (0x3a09, 0x27), (0x3a0a, 0x00), (0x3a0b, 0xf6), (0x3a0e, 0x03), (0x3a0d, 0x04), (0x3a14, 0x03), (0x3a15, 0xd8), (0x4004, 0x02), (0x3002, 0x1c), (0x4713, 0x03), (0x3002, 0x00), (0x4713, 0x02), (0x4837, 0x16), (0x3824, 0x04), (0x5001, 0x83), (0x3035, 0x21), (0x3036, 0x46), (0x4837, 0x22), (0x5001, 0xa3)]
    
    #ov5640_for_td8801.c /* 2592X1944 QSXGA */
    #preview = [(0x3503, 0x07), (0x3a00, 0x78), (0x350c, 0x00), (0x350d, 0x00), (0x3c07, 0x07), (0x3820, 0x40), (0x3821, 0x06), (0x3814, 0x11), (0x3815, 0x11), (0x3803, 0x00), (0x3807, 0x9f), (0x3808, 0x05), (0x3809, 0x00), (0x380a, 0x04), (0x380b, 0x00), (0x380c, 0x0b), (0x380d, 0x1c), (0x380e, 0x07), (0x380f, 0xb0), (0x3813, 0x04), (0x3618, 0x04), (0x3612, 0x2b), (0x3709, 0x12), (0x370c, 0x00), (0x3a02, 0x07), (0x3a03, 0xb0), (0x3a0e, 0x06), (0x3a0d, 0x08), (0x3a14, 0x07), (0x3a15, 0xb0), (0x4004, 0x06), (0x3035, 0x21), (0x3036, 0x46), (0x4837, 0x2c), (0x5001, 0xa3)]

    #sensor_720p_120fps_regs
    preview760x1344 =   [(0x0100, 0x00), # sleep
    (0xffff,0x40),
    (0x030d, 0x1d),#  ; PLL2 multiplier 0x1e:for 110fps, 0x21 for 120fps (0x1d)
    (0xffff,0x40),
    (0x3501, 0x00),# ; long exposure H (0x31)
    (0x3502, 0xF0),# ; long exposure L (0x00)
    ...
    (0x3807, 0xfb),#  ; V crop end L
    (0x3808, 0x05),#  ; H output size H (0x05)
    (0x3809, 0x40),#  ; H output size L (0x40)
    (0x380a, 0x02),#  ; V output size H
    (0x380b, 0xf8),#  ; V output size L (0xf8)
    (0x380d, 0x58),#  ; HTS L
    (0x380e, 0x03),#  ; VTS H
    (0x380f, 0x1d),#  ; VTS L
    (0x3811, 0x08),#  ; H win off L
    ...
    preview720x800 =   [(0x0100, 0x00), # sleep
    (0xffff,0x40),
    (0x030d, 0x1d),#  ; PLL2 multiplier 0x1e:for 110fps, 0x21 for 120fps (0x1d)
    (0xffff,0x40),
    ...
    (0x3800, 0x00),#  ; H crop start H
    (0x3801, 0x08),#  ; H crop start L
    (0x3803, 0x08),#  ; V crop start L
    (0x3804, 0x0a),#  ; H crop end H
    (0x3805, 0x9f),#  ; H crop end L
    (0x3807, 0xfb),#  ; V crop end L
    (0x3808, 0x03),#  ; H output size H (0x05)
    (0x3809, 0x20),#  ; H output size L (0x40)
    (0x380a, 0x02),#  ; V output size H
    (0x380b, 0xd0),#  ; V output size L (0xf8)
    (0x380d, 0x58),#  ; HTS L
    (0x380e, 0x03),#  ; VTS H
    (0x380f, 0x1d),#  ; VTS L
    (0x3811, 0x08),#  ; H win off L
    ...
    preview1560x2440 =   [(0x0100, 0x00), # sleep
    (0xffff,0x40),
    (0x030d, 0x1d),#  ; PLL2 multiplier 0x1e:for 110fps, 0x21 for 120fps (0x1d)
    (0xffff,0x40),
    (0x3501, 0x00),# ; long exposure H (0x31)
    ...
    for s in preview1560x2440:	#760x1344
        print(hex(s[1]))
        print('jodelahiti')
        write_block(smb,s[0],[s[1]])
