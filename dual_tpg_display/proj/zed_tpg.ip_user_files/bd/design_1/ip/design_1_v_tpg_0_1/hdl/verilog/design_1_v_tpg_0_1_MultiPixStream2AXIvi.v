...
module design_1_v_tpg_0_1_MultiPixStream2AXIvi (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] exitcond2_reg_485;
reg    strmPix_V_val_1_V_blk_n;
reg    strmPix_V_val_2_V_blk_n;
reg    m_axis_video_TDATA_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] exitcond2_reg_485_pp0_iter1_reg;
reg    ap_enable_reg_pp0_iter3;
reg   [0:0] exitcond2_reg_485_pp0_iter2_reg;
reg   [10:0] j_reg_210;
reg    ap_block_state1;
...
wire   [11:0] tmp_137_fu_274_p1;
reg   [11:0] tmp_137_reg_461;
wire   [11:0] tmp_138_fu_278_p1;
reg   [11:0] tmp_138_reg_466;
wire   [11:0] tmp_124_fu_282_p2;
reg   [11:0] tmp_124_reg_471;
wire   [0:0] exitcond1_fu_292_p2;
wire    ap_CS_fsm_state3;
reg    ap_block_state3;
wire   [10:0] i_1_fu_297_p2;
reg   [10:0] i_1_reg_480;
...
wire   [10:0] j_1_fu_312_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] tmp_last_V_fu_318_p2;
reg   [0:0] tmp_last_V_reg_494;
reg   [0:0] tmp_last_V_reg_494_pp0_iter1_reg;
reg   [7:0] tmp_val_0_V_reg_499;
reg   [7:0] tmp_val_1_V_reg_504;
reg   [7:0] tmp_val_2_V_reg_510;
wire   [23:0] p_Result_3_fu_335_p3;
wire   [23:0] p_Result_s_fu_343_p3;
wire   [23:0] p_Result_4_fu_351_p3;
...
wire   [23:0] p_Result_4_0_1_fu_383_p5;
wire   [23:0] ap_phi_reg_pp0_iter2_p_019_0_2_0_1_reg_232;
wire   [23:0] p_Result_3_0_1_fu_359_p5;
wire   [23:0] p_Result_0_1_fu_371_p5;
...
wire   [23:0] p_Result_3_0_2_fu_395_p5;
wire   [23:0] p_Result_0_2_fu_407_p5;
...
wire   [11:0] i_cast_fu_288_p1;
wire   [11:0] j_cast_fu_303_p1;
reg   [4:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
design_1_v_tpg_0_1_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_257(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
design_1_v_tpg_0_1_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_263(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state4) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (exitcond1_fu_292_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_652)) begin
        if (((exitcond2_reg_485 == 1'd0) & (colorFormat_read_read_fu_154_p2 == 8'd0))) begin
            ap_phi_reg_pp0_iter2_p_019_0_2_reg_221 <= p_Result_s_fu_343_p3;
        end else if (((exitcond2_reg_485 == 1'd0) & (colorFormat_read_read_fu_154_p2 == 8'd1))) begin
            ap_phi_reg_pp0_iter2_p_019_0_2_reg_221 <= p_Result_3_fu_335_p3;
        end else if ((1'b1 == ap_condition_612)) begin
            ap_phi_reg_pp0_iter2_p_019_0_2_reg_221 <= p_Result_4_fu_351_p3;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (exitcond1_fu_292_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        j_reg_210 <= 11'd0;
    end else if (((exitcond2_fu_307_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_reg_210 <= j_1_fu_312_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond2_reg_485_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == AXI_video_strm_V_last_V_1_load_A)) begin
        AXI_video_strm_V_last_V_1_payload_A <= tmp_last_V_reg_494_pp0_iter1_reg;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == AXI_video_strm_V_last_V_1_load_B)) begin
        AXI_video_strm_V_last_V_1_payload_B <= tmp_last_V_reg_494_pp0_iter1_reg;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        exitcond2_reg_485 <= exitcond2_fu_307_p2;
        exitcond2_reg_485_pp0_iter1_reg <= exitcond2_reg_485;
        tmp_last_V_reg_494_pp0_iter1_reg <= tmp_last_V_reg_494;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        exitcond2_reg_485_pp0_iter2_reg <= exitcond2_reg_485_pp0_iter1_reg;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (1'b1 == ap_CS_fsm_state3))) begin
        i_1_reg_480 <= i_1_fu_297_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_on_subcall_done) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_124_reg_471 <= tmp_124_fu_282_p2;
        tmp_137_reg_461 <= tmp_137_fu_274_p1;
        tmp_138_reg_466 <= tmp_138_fu_278_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond2_fu_307_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_last_V_reg_494 <= tmp_last_V_fu_318_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond2_reg_485 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_val_0_V_reg_499 <= strmPix_V_val_0_V_dout;
        tmp_val_1_V_reg_504 <= strmPix_V_val_1_V_dout;
        tmp_val_2_V_reg_510 <= strmPix_V_val_2_V_dout;
    end
end
...
always @ (*) begin
    if ((exitcond2_fu_307_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_475)) begin
        if ((colorFormat_read_read_fu_154_p2 == 8'd0)) begin
            ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6 = p_Result_0_1_fu_371_p5;
        end else if ((colorFormat_read_read_fu_154_p2 == 8'd1)) begin
            ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6 = p_Result_3_0_1_fu_359_p5;
        end else if ((~(colorFormat_read_read_fu_154_p2 == 8'd0) & ~(colorFormat_read_read_fu_154_p2 == 8'd1))) begin
            ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6 = p_Result_4_0_1_fu_383_p5;
        end else begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_475)) begin
        if ((colorFormat_read_read_fu_154_p2 == 8'd0)) begin
            ap_phi_mux_tmp_data_V_phi_fu_247_p6 = p_Result_0_2_fu_407_p5;
        end else if ((colorFormat_read_read_fu_154_p2 == 8'd1)) begin
            ap_phi_mux_tmp_data_V_phi_fu_247_p6 = p_Result_3_0_2_fu_395_p5;
        end else if ((~(colorFormat_read_read_fu_154_p2 == 8'd0) & ~(colorFormat_read_read_fu_154_p2 == 8'd1))) begin
...
always @ (*) begin
    if ((((exitcond2_reg_485_pp0_iter2_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((exitcond2_reg_485_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    if (((exitcond2_reg_485 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((exitcond2_reg_485 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((exitcond2_fu_307_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((exitcond2_fu_307_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond2_reg_485 == 1'd0) & (strmPix_V_val_0_V0_status == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state7_io) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((exitcond2_reg_485 == 1'd0) & (strmPix_V_val_0_V0_status == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state7_io) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((exitcond2_reg_485 == 1'd0) & (strmPix_V_val_0_V0_status == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = ((exitcond2_reg_485 == 1'd0) & (strmPix_V_val_0_V0_status == 1'b0));
end

always @ (*) begin
    ap_block_state6_io = ((exitcond2_reg_485_pp0_iter1_reg == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end

assign ap_block_state6_pp0_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state7_io = ((exitcond2_reg_485_pp0_iter2_reg == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end

assign ap_block_state7_pp0_stage0_iter3 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_condition_475 = ((exitcond2_reg_485_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_condition_612 = (~(colorFormat_read_read_fu_154_p2 == 8'd0) & ~(colorFormat_read_read_fu_154_p2 == 8'd1) & (exitcond2_reg_485 == 1'd0));
end
...
assign exitcond1_fu_292_p2 = ((i_cast_fu_288_p1 == tmp_138_reg_466) ? 1'b1 : 1'b0);

assign exitcond2_fu_307_p2 = ((j_cast_fu_303_p1 == tmp_137_reg_461) ? 1'b1 : 1'b0);
...
assign i_1_fu_297_p2 = (i_reg_199 + 11'd1);

assign i_cast_fu_288_p1 = i_reg_199;

assign j_1_fu_312_p2 = (j_reg_210 + 11'd1);

assign j_cast_fu_303_p1 = j_reg_210;
...
assign p_Result_0_1_fu_371_p5 = {{ap_phi_reg_pp0_iter2_p_019_0_2_reg_221[23:16]}, {tmp_val_2_V_reg_510}, {ap_phi_reg_pp0_iter2_p_019_0_2_reg_221[7:0]}};

assign p_Result_0_2_fu_407_p5 = {{tmp_val_0_V_reg_499}, {ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6[15:0]}};

assign p_Result_3_0_1_fu_359_p5 = {{ap_phi_reg_pp0_iter2_p_019_0_2_reg_221[23:16]}, {tmp_val_1_V_reg_504}, {ap_phi_reg_pp0_iter2_p_019_0_2_reg_221[7:0]}};

assign p_Result_3_0_2_fu_395_p5 = {{tmp_val_2_V_reg_510}, {ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6[15:0]}};

assign p_Result_3_fu_335_p3 = {{16'd65535}, {strmPix_V_val_0_V_dout}};

assign p_Result_4_0_1_fu_383_p5 = {{ap_phi_reg_pp0_iter2_p_019_0_2_reg_221[23:16]}, {tmp_val_1_V_reg_504}, {ap_phi_reg_pp0_iter2_p_019_0_2_reg_221[7:0]}};

assign p_Result_4_0_2_fu_419_p5 = {{tmp_val_2_V_reg_510}, {ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6[15:0]}};

assign p_Result_4_fu_351_p3 = {{16'd65535}, {strmPix_V_val_0_V_dout}};

assign p_Result_s_fu_343_p3 = {{16'd65535}, {strmPix_V_val_1_V_dout}};
...
assign tmp_124_fu_282_p2 = ($signed(12'd4095) + $signed(tmp_137_fu_274_p1));

assign tmp_137_fu_274_p1 = grp_reg_unsigned_short_s_fu_263_ap_return[11:0];

assign tmp_138_fu_278_p1 = grp_reg_unsigned_short_s_fu_257_ap_return[11:0];

assign tmp_last_V_fu_318_p2 = ((j_cast_fu_303_p1 == tmp_124_reg_471) ? 1'b1 : 1'b0);

endmodule //design_1_v_tpg_0_1_MultiPixStream2AXIvi
