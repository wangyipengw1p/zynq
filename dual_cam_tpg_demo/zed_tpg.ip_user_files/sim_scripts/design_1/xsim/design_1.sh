...
{
  file="xsim.ini"
  lib_map_path="/esat/micas-data/software/xilinx_vivado_2018.2/Vivado/2018.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
